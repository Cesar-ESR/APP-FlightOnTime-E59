...
public class WeatherController {
    ...
    /**
     * Endpoint para obtener datos meteorológicos usando código IATA del aeropuerto
     *
     * @param iataCode código IATA del aeropuerto
     * @return ResponseEntity con WeatherData o 404 si no se encuentra el aeropuerto
     */
